                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img
                                                src="{{ asset('admin/assets/img/small-logos/logo-atlassian.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img
                                                src="{{ asset('admin/assets/img/small-logos/logo-slack.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img
                                                src="{{ asset('admin/assets/img/small-logos/logo-spotify.svg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <img
                                                src="{{ asset('admin/assets/img/small-logos/logo-invision.svg') }}"
